...
func ToSexp(o interface{}, indentation ...int) string {
        ...
        case *OrgSrcBlock:
                ...
                sexp += fmt.Sprintf("\n%s(src-block (:language %s :switches %s :parameters %s :value %s)", indent, strconv.Quote(oo.Lang), strconv.Quote(oo.Switches), strconv.Quote(oo.Headers), strconv.Quote(oo.RawContent))
